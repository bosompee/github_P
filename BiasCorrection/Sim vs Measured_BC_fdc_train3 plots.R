...
mf1C <- subset(mfC, Date >= "1980-10-01" & Year <= 2000)
...
df_seg1C <- subset(df_segC, Date >= "1980-10-01" & Year <= 2000)
...
mf1B <- subset(mfB, Date >= "1980-10-01" & Year <= 2000)
...
df_seg1B <- subset(df_segB, Date >= "1980-10-01" & Year <= 2000)
